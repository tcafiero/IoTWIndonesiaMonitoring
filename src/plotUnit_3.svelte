...
<iframe width="85%" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/{channel}/charts/{fieldpH}?api_key={API_key}&width=auto&heigth=auto&bgcolor=%23ffffff&color=%23d62020&days={$days}&dynamic={dynamic}&yaxismax=11&yaxismin=4&{$filter}&title={titlepH}&type=spline&update=1&yaxis=pH"></iframe>
